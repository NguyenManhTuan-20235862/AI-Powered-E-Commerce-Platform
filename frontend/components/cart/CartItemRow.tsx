  ...
  return (
    <div className="relative flex flex-col items-center gap-4 rounded-xl bg-surface p-4 shadow-sm transition-shadow hover:shadow-warm sm:flex-row">
      <button
        ...
        className="absolute right-1 top-1 flex h-11 w-11 items-center justify-center text-foreground-muted transition-colors hover:text-error disabled:cursor-not-allowed disabled:opacity-50"
      >
